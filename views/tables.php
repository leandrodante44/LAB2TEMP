              ...
              <tr>
                <th scope="row">
                  <div class="media align-items-center">
                    ...
                    <div class="media-body">
                      <span class="name mb-0 text-sm">Leandro Dante Oliveira</span>
                    </div>
                  </div>
                </th>
                <td class="budget">
                ...
                <td>
                  <div class="avatar-group">
                    <a href="#" class="avatar avatar-sm rounded-circle bg-success" data-toggle="tooltip" data-original-title="01/01/2020 07:00">
                      <span><b>35</b></span>
                    </a>
                    <a href="#" class="avatar avatar-sm rounded-circle bg-success" data-toggle="tooltip" data-original-title="01/01/2020 12:00">
                      <span><b>35</b></span>
                    </a>
                    <a href="#" class="avatar avatar-sm rounded-circle bg-success" data-toggle="tooltip" data-original-title="02/01/2020 12:00">
                      <span><b>35</b></span>
                    </a>
                    <a href="#" class="avatar avatar-sm rounded-circle bg-warning" data-toggle="tooltip" data-original-title="03/01/2020 07:00">
                      <span><b>37</b></span>
                    </a>
                  </div>
                </td>
              ...
              <tr>
                <th scope="row">
                  <div class="media align-items-center">
                    ...
                    <div class="media-body">
                      <span class="name mb-0 text-sm">Flavio Barba</span>
                    </div>
                  </div>
                </th>
                <td class="budget">
                ...
                <td>
                  <div class="d-flex align-items-center">
                    <span class="completion mr-2">36 °C</span>
                    <div>
                      <div class="progress">
              ...
              <tr>
                <th scope="row">
                  <div class="media align-items-center">
                    ...
                    <div class="media-body">
                      <span class="name mb-0 text-sm">Lael Jader</span>
                    </div>
                  </div>
                </th>
                <td class="budget">
                ...
                <td>
                  <span class="badge badge-dot mr-4">
                    <i class="bg-danger"></i>
                    <span class="status">Afastado</span>
                  </span>
                </td>
                <td>
                  <div class="avatar-group">
                    ...
                    <a href="#" class="avatar avatar-sm rounded-circle bg-warning" data-toggle="tooltip" data-original-title="02/01/2020 12:00">
                      <span><b>37</b></span>
                    </a>
                    <a href="#" class="avatar avatar-sm rounded-circle bg-danger" data-toggle="tooltip" data-original-title="03/01/2020 07:00">
                      <span><b>39</b></span>
                    </a>
                  </div>
                </td>
                <td>
                  <div class="d-flex align-items-center">
                    <span class="completion mr-2">39 °C</span>
                    <div>
                      <div class="progress">
                        <div class="progress-bar bg-danger" role="progressbar" aria-valuenow="95" aria-valuemin="0" aria-valuemax="100" style="width: 95%;"></div>
                      </div>
                    </div>
                  </div>
                </td>
              ...
              <tr>
                <th scope="row">
                  <div class="media align-items-center">
                    ...
                    <div class="media-body">
                      <span class="name mb-0 text-sm">Bruno Vianna</span>
                    </div>
                  </div>
                </th>
                <td class="budget">
                ...
                <td>
                  <div class="d-flex align-items-center">
                    <span class="completion mr-2">38,5 °C</span>
                    <div>
                      <div class="progress">
                        <div class="progress-bar bg-danger" role="progressbar" aria-valuenow="90" aria-valuemin="0" aria-valuemax="100" style="width: 90%;"></div>
                      </div>
                    </div>
                  </div>
                </td>
              ...
              <tr>
                <th scope="row">
                  <div class="media align-items-center">
                    ...
                    <div class="media-body">
                      <span class="name mb-0 text-sm">João Victor Nery</span>
                    </div>
                  </div>
                </th>
                <td class="budget">
                ...
                <td>
                  <div class="d-flex align-items-center">
                    <span class="completion mr-2">36,5 °C</span>
                    <div>
                      <div class="progress">
                        <div class="progress-bar bg-warning" role="progressbar" aria-valuenow="100" aria-valuemin="0" aria-valuemax="100" style="width: 75%;"></div>
                      </div>
                    </div>
                  </div>
                </td>
